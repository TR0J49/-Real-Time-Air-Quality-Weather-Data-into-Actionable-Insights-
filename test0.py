...
app.layout = html.Div(
    ...
    children=[
        html.H1("Real-Time Air Quality Dashboard", style={'text-align': 'center', 'color': 'cyan'}),

        # Input for city search
        dcc.Input(id="city-input", type="text", placeholder="Enter city name", value='Delhi',
                  style={'width': '30%', 'padding': '20px', 'margin-bottom': '20px',
        ...
        html.Div(id='current-datetime',
                 style={'font-size': '25px', 'margin-bottom': '20px', 'color': 'cyan', 'text-align': 'center'}),
        ...
        html.Footer(
            ...
            children=[
                html.Div("Developed by Shubham Rahangdale", style={'font-size': '30px'}),
...
def update_charts(city, n):
    ...
    heatmap_fig.update_layout(title='Temperature and Humidity Heatmap',
                              paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', font=dict(color='cyan'))
