    ...
    children=[
        ...
        dcc.Input(id="city-input", type="text", placeholder="Enter city name", value='Delhi',
                  style={'width': '50%', 'padding': '10px', 'margin-bottom': '20px',
                         'display': 'block', 'margin': '0 auto', 'border-radius': '5px', 'border': '1px solid cyan'}),

        # Display real-time date and time
        html.Div(id='current-datetime',
                 style={'font-size': '20px', 'margin-bottom': '20px', 'color': 'cyan', 'text-align': 'center'}),
...
def update_charts(city, n):
    ...
    heatmap_fig.update_layout(title="Weather Conditions Heatmap",
